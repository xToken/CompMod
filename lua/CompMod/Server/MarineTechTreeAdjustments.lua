...
// lua\CompMod\Server\MarineTechTreeAdjustments.lua
// - Dragon

// Comp Mod changes to marine tech.
function MarineTeam:InitTechTree()
   ...
   PlayingTeam.InitTechTree(self)
    ...
    self.techTree:AddTargetedBuyNode(kTechId.GrenadeLauncher,  kTechId.GrenadeLauncherTech)
    self.techTree:AddTargetedActivation(kTechId.DropGrenadeLauncher,  kTechId.GrenadeLauncherTech)
    
	self.techTree:AddResearchNode(kTechId.FlamethrowerTech,      kTechId.Armory,      kTechId.None)
    self.techTree:AddTargetedBuyNode(kTechId.Flamethrower,     kTechId.FlamethrowerTech)
    self.techTree:AddTargetedActivation(kTechId.DropFlamethrower,    kTechId.FlamethrowerTech)
	
	self.techTree:AddResearchNode(kTechId.HeavyMachineGunTech,      kTechId.AdvancedArmory,      kTechId.None)
    self.techTree:AddTargetedBuyNode(kTechId.HeavyMachineGun,     kTechId.HeavyMachineGunTech)
    self.techTree:AddTargetedActivation(kTechId.DropHeavyMachineGun,    kTechId.HeavyMachineGunTech)
    ...
    //self.techTree:AddResearchNode(kTechId.DualMinigunTech,       kTechId.ExosuitTech, kTechId.None)
    ...
    //self.techTree:AddResearchNode(kTechId.DualRailgunTech,       kTechId.ExosuitTech, kTechId.None)
