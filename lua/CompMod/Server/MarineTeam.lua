...
-- lua\CompMod\Server\MarineTeam.lua
-- - Dragon
...
function MarineTeam:InitTechTree()
   ...
   -- Passives, other utility things
	...
	self.techTree:AddResearchNode(kTechId.ShotgunUpgrade1,			kTechId.AdvancedArmory)
	self.techTree:AddResearchNode(kTechId.ShotgunUpgrade2,			kTechId.PrototypeLab)
	self.techTree:AddResearchNode(kTechId.MGUpgrade1,				kTechId.AdvancedArmory)
	self.techTree:AddResearchNode(kTechId.MGUpgrade2,				kTechId.PrototypeLab)
	...
	self.techTree:AddResearchNode(kTechId.MinigunUpgrade2,			kTechId.PrototypeLab)
