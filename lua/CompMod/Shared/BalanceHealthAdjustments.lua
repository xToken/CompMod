...
//kSkulkHealthPerBioMass = 3		// Comp Mod change, currently unchanged.

//kGorgeHealth = 160				// Comp Mod change, currently unchanged.
//kGorgeArmor = 75					// Comp Mod change, currently unchanged.
...
//kLerkHealthPerBioMass = 2			// Comp Mod change, currently unchanged.
...
//kOnosHealtPerBioMass = 25			// Comp Mod change, currently unchanged.