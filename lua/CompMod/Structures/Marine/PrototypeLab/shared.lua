...
function PrototypeLab:GetTechButtons(techId)
	...
	local techButtons = { kTechId.NanoArmor, kTechId.JetpackTech, kTechId.ExoUpgrade1, kTechId.None, 
             kTechId.None, kTechId.None, kTechId.None, kTechId.None }
			 
	if GetHasTech(self, kTechId.JetpackTech) then
        techButtons[2] = kTechId.JetpackUpgrade1
    end

	if GetHasTech(self, kTechId.ExoUpgrade1) then
        techButtons[3] = kTechId.ExoUpgrade2
    end
