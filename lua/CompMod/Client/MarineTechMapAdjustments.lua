...
// lua\CompMod\Client\MarineTechMapAdjustments.lua
// - Dragon
...
kMarineTechMap =
{
        ...
        { kTechId.GrenadeTech, 2, 3 },{ kTechId.MinesTech, 3, 3 },{ kTechId.ShotgunTech, 4, 3 },{ kTechId.FlamethrowerTech, 5, 3 },{ kTechId.Welder, 6, 3 },
        
        { kTechId.Armory, 3.5, 4 }, 
         
        { kTechId.HeavyMachineGunTech, 2.5, 5.5 },{ kTechId.GrenadeLauncherTech, 3.5, 5.5 }, { kTechId.AdvancedArmory, 4.5, 5.5 },
...
kMarineLines = 
{
	...
	GetLinePositionForTechMap(kMarineTechMap, kTechId.Armory, kTechId.FlamethrowerTech),
